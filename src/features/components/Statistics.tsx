  ...
  export default function Statistics() {
    return (
      <div className="relative isolate overflow-hidden bg-gray-500 py-24 sm:py-32">
        ...
        >
          <div
            className="aspect-[1097/845] w-[68.5625rem] bg-gradient-to-tr from-[#4b558f] to-[#55dd67] opacity-40"
            style={{
              clipPath:
        ...
        >
          <div
            className="aspect-[1097/845] w-[68.5625rem] bg-gradient-to-tr from-[#3d9c35] to-[#2d2792] opacity-40"
            style={{
              clipPath:
                'polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)',
            }}
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto text-center lg:mx-0">
            <h2 className="text-4xl font-bold tracking-tight text-white sm:text-6xl">Churches</h2>
