...
export default function PageBanner2({imageBannerSrc}: Props) {
  return (
    <div className="isolate overflow-hidden bg-gray-900">
      ...
      />
      <div className="mx-auto max-w-7xl px-6 pt-24 pb-24 lg:pt-52 lg:pb-52 text-center lg:px-8">
        <div className="mx-auto max-w-4xl">
          {/* <h2 className="text-base font-semibold leading-7 text-indigo-400">Pricing</h2> */}
          <p className="mt-2 text-3xl font-bold tracking-tight text-white lg:text-5xl">
                ...
                >
                  <div>
                    ...
                    <div className="mt-2 flex items-baseline gap-x-2">
                      <span className="text-2xl lg:text-4xl font-bold tracking-tight text-appGreen">{tier.priceMonthly}</span>
                      {/* <span className="text-base font-semibold leading-7 text-gray-600">/month</span> */}
                    </div>
                    <p className="mt-6 text-base leading-7 text-appBlue">{parse(tier.description)}</p>
